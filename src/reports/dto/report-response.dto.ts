...
export class ReportResponseDto {
  ...
  @ApiPropertyOptional({
    description: 'Institute information if report is institute-specific',
  })
  institute?: {
    id: string;
    name: string;
  ...
  @ApiPropertyOptional({
    description: 'Student information if report is student-specific',
  })
  student?: {
    id: string;
    name: string;
  ...
  @ApiPropertyOptional({
    description: 'Subject information if report is subject-specific',
  })
  subject?: {
    id: string;
    name: string;
  ...
  @ApiPropertyOptional({
    description: 'Course information if report is course-specific',
  })
  course?: {
    id: string;
    name: string;
  ...
  @ApiPropertyOptional({
    description: 'Package information if report is package-specific',
  })
  package?: {
    id: string;
    name: string;
  ...
  @ApiPropertyOptional({
    description: 'Test information if report is test-specific',
  })
  test?: {
    id: string;
    name: string;
